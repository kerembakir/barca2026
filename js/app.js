import { ontsleutel, sleutelUitLink, onthoudSleutel, bewaardeSleutel } from './slot.js?v=9b3eaf1f'
import { SPELLEN } from './spellen.js?v=9b3eaf1f'
import { schermOefeningen } from './oefeningen.js?v=9b3eaf1f'

const $app = document.getElementById('app')
const OPSLAG = 'barca2026:staat'
const VRIJ = 'barca2026:vrijgespeeld'
...
// Het programma is pas te lezen als je de week hebt uitgespeeld.
function vrijgespeeld() { try { return localStorage.getItem(VRIJ) === 'ja' } catch { return false } }
function speelVrij() { try { localStorage.setItem(VRIJ, 'ja') } catch {} }
    ...
    <div class="scherm titelscherm">
      ...
      <div class="knoppen">
        ...
        ${vrijgespeeld()
          ...
          : '<p class="slotje">Het programma zit achter de week. Speel hem uit, dan krijg je hem.</p>'}
      </div>
    ...
    schermOefeningen(null, {
      ...
      const klaar = el(`
        <div class="scherm">
          ...
          <div class="tekst">
            <p>Dat was het. Vanaf nu staat het programma gewoon op het titelscherm, ook als je opnieuw begint.</p>
...
function toonProgramma() {
  if (!vrijgespeeld()) return toast('Het programma komt vrij als je de week hebt uitgespeeld.')
